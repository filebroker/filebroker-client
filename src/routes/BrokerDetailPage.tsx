...
import {
    Broker,
    BrokerAccess,
    BrokerAuditLogInnerJoined,
    BrokerDetailed,
    isBrokerDetailed,
    updateBrokerWithValues,
    UserGroup,
    UserPublic,
} from "../Model";
...
export function BrokerAccessCreator({
    broker,
    modal,
    app,
}: {
    broker: Broker | BrokerDetailed;
    modal?: ModalContent;
    app: App;
}) {
                        ...
                        <FormGroup className="form-container">
                            ...
                            <StyledAutocomplete
                                ...
                                helperText={
                                    isGroupInvalid
                                        ? isAdminAccess
                                            ? "Group is required for admin access"
                                            : "Group is required"
                                        : undefined
                                }
                            />
                            ...
                            <div className="flex-row">
                                ...
                                />
                                <Tooltip
                                    title="BEWARE: Granting admin privileges means that admins of the selected groups will be able to view broker credentials, edit broker details and bucket configuration and grant access to other groups and users."
                                    placement="right"
                                    arrow
                                >
                                    <FontAwesomeIcon
                    ...
                    <TabPanel value={activeTab} index={1}>
                        <FormGroup className="form-container">
                            ...
                            <div className="flex-row">
                                ...
                                />
                                <Tooltip
                                    title="BEWARE: Granting admin privileges means that the selected user will be able to view broker credentials, edit broker details and bucket configuration and grant access to other groups and users."
                                    placement="right"
                                    arrow
                                >
                                    <FontAwesomeIcon
                        ...
                        <FormGroup className="form-container">
                            ...
                            <TextField
                                ...
                                helperText={
                                    isQuotaInvalid
                                        ? quota === null
                                            ? "Quota may not be empty for public access."
                                            : "Quota must be empty or greater than 0."
                                        : undefined
                                }
                            />
...
export function ChangeQuotaForm({
    broker,
    brokerAccess,
    modal,
    app,
...
export function ChangeTotalQuotaForm({
    broker,
    modal,
    app,
}: {
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="flex-row">
                                    ...
                                    />
                                    <Tooltip
                                        title="With this option enabled, duplicate files uploads that generate the same file hash will be removed and new posts will reference the existing file instead."
                                        placement="right"
                                        arrow
                                    >
                                ...
                                <div className="flex-row">
                                    ...
                                    />
                                    <Tooltip
                                        title="With this option enabled, clients can stream content from the bucket directly using a presigned get URL, rather than through the filebroker server. Requires CORS permissions adding the filebroker domain as allowed origin for your bucket."
                                        placement="right"
                                        arrow
                                    >
                                        <FontAwesomeIcon icon={faCircleInfo} />
                                ...
                                >
                                    ...
                                    />
                                    <Tooltip
                                        title="Set this bucket as the system bucket, which will be used for storing system data such as user avatars. There is no more than one system bucket, so setting this bucket as system will remove the previous system bucket."
                                        placement="right"
                                        arrow
                                    >
                                        <FontAwesomeIcon icon={faCircleInfo} />
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="flex-row">
                                            ...
                                            />
                                            <Tooltip
                                                title="Check if this S3 bucket is hosted on AWS S3, in which case you can specify the AWS region, rather than an endpoint URL."
                                                placement="right"
                                                arrow
                                            >
                                                <FontAwesomeIcon
                        ...
                        <>
                            ...
                            >
                                <ReadOnlyTextField
                                    label="Your Usage"
                                    variant="standard"
                                    value={`${formatBytes(broker.used_quota)} (${formatBytes(broker.used_bytes)}) / ${broker.quota_bytes ? formatBytes(broker.quota_bytes) : "∞"}`}
                                />
                                {broker.total_used_bytes && (
                                    <ReadOnlyTextField
                                        label="Total Usage"
                                        variant="standard"
                                        value={
                                            broker.total_quota
                                                ? `${formatBytes(broker.total_used_bytes)} / ${formatBytes(broker.total_quota)}`
                                                : `${formatBytes(broker.total_used_bytes)}`
                                        }
                                    />
                                )}
                                <ReadOnlyTextField
                                                    ...
                                                    <ActionModal
                                                        ...
                                                        text={
                                                            broker.disable_uploads
                                                                ...
                                                                : "Temporarily prevent users from uploading to this broker. The broker owner and admins are exempt from this restriction."
                                                        }
                                                        actions={[
                                                            {
                                                                name: "Ok",
                        ...
                        <Paper elevation={2} className="fieldset-paper">
                            <div className="form-paper-content">
                                ...
                                <TabPanel value={activeTab} index={0}>
                                                                ...
                                                                actions={[
                                                                    {
                                                                        ...
                                                                        fn: async () => {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                const response =
                                                                                    await http.post<BrokerAccess>(
                                                                                        `/change-broker-access-admin/${broker.pk}/${brokerAccess.pk}`,
                                                                                        {
                                                                                            is_admin: true,
                                                                                        },
                                                                                        config
                                                                ...
                                                                actions={[
                                                                    {
                                                                        ...
                                                                        fn: async () => {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                const response =
                                                                                    await http.delete<BrokerAccess>(
                                    ...
                                    />
                                    <div
                                        className="form-paper-button-row"
                                        style={{
                                            marginTop: "10px",
                                            marginBottom: "10px",
                                        }}
