            ...
            <Paper elevation={2} className="fieldset-paper">
                <div className="form-paper-content">
                    ...
                    <div className="flex-row">
                        ...
                        />
                        <Tooltip
                            title="Public groups are visible for all users and can be joined without invite."
                            placement="right"
                            arrow
                        >
                    ...
                    <div className="flex-row">
                        ...
                        />
                        <Tooltip
                            title="Allows non-admin users to invite new members, this option is ineffective for public groups."
                            placement="right"
                            arrow
                        >
                            <FontAwesomeIcon icon={faCircleInfo} />
...
export function GroupDetailPage({ app }: { app: App }) {
    ...
    const memberUpdateAction = (
        tableRef: React.RefObject<PaginatedTableHandle | null>,
        label: string,
        modalTextFn: (member: UserGroupMembershipInnerJoined) => string,
        requestBodyFn: (value?: string) => {
                                        ...
                                        <PaginatedTable<UserGroupMembershipInnerJoined>
                                            ...
                                            rowActions={[
                                                memberUpdateAction(
                                                    ...
                                                    "Promote to Admin",
                                                    (member) =>
                                                        `Promote ${member.user.display_name ?? member.user.user_name} to admin?`,
                                                    (_) => ({
                                                        action: "promote",
                                                    }),
                                                    (member) =>
                                                ...
                                                memberUpdateAction(
                                                    ...
                                                    "Demote Admin",
                                                    (member) =>
                                                        `Demote admin ${member.user.display_name ?? member.user.user_name} and remove admin privileges?`,
                                                    (_) => ({
                                                        action: "demote",
                                                    }),
                                                    (member) =>
                                                ...
                                                memberUpdateAction(
                                                    ...
                                                    "Kick Member",
                                                    (member) =>
                                                        `Kick user ${member.user.display_name ?? member.user.user_name}? Kicked users will have their membership deleted but may join / be invited again. You may optionally specify a reason below.`,
                                                    (reason) => ({
                                                        action: "kick",
                                                        reason: reason,
                                                    }),
                                                ...
                                                memberUpdateAction(
                                                    ...
                                                    "Ban Member",
                                                    (member) =>
                                                        `Ban user ${member.user.display_name ?? member.user.user_name}? Banned users will have their membership revoked and will not be able to join / be invited again until unbanned. You may optionally specify a reason below.`,
                                                    (reason) => ({
                                                        action: "ban",
                                                        reason: reason,
                                                    }),
                                        ...
                                        <PaginatedTable<UserGroupMembershipInnerJoined>
                                            ...
                                            rowActions={[
                                                memberUpdateAction(
                                                    ...
                                                    "Unban Member",
                                                    (member) =>
                                                        `Unban user ${member.user.display_name ?? member.user.user_name}? After unbanning, the user will be able to join / be invited again.`,
                                                    () => ({ action: "unban" }),
                                                    (member) =>
