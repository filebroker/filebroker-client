        ...
        if (post) {
            setMediaComponent(
                <div id="post-container-media-container">
                    <div
                        ref={mediaComponentElementCallback}
                        style={{
                            height: "max-content",
                            width: "max-content",
    ...
    if (post) {
        ...
        postContainerButtonGroup = (
            ...
            >
                ...
                {post.is_deletable && (
                    ...
                    >
                        <FontAwesomeSvgIcon fontSize="inherit" icon={faTrash} />
                    </Button>
                )}
                {post?.s3_object && (
                    <Button
        ...
        postInformation = (
            <>
                ...
                <div>
                    ...
                    {new Date(post.creation_timestamp).toLocaleString()}
                </div>
            </>
        );
        ...
        if (post.prev_post) {
            ...
            let location: Partial<Location> = {
                pathname: basePostPath + post.prev_post.pk,
        ...
        <div id="Post">
            <div id="post-container">
                <div id="post-container-top-row">
                    ...
                    {post?.s3_object?.hls_master_playlist ? (
                        <FormControlLabel
                            className="inline-form-control-label"
                            control={
                                <Switch
                                    checked={hlsEnabled}
                                    onChange={(_e, checked) => {
                ...
                <div id="post-container-bottom-row">
                    <div
                        className="post-container-information"
                        style={{
            ...
            <div id="post-information-container">
                ...
                {isEditMode ? (
                    ...
                    <h2 hidden={!(post && post.title)}>{post && post.title}</h2>
                )}
                {isEditMode ? (
                    <TextField
                        label="Description"
                ...
                <div className="material-row-flex">
                    <VisibilitySelect
                        isPublic={publicPost}
                        isPublicEdit={publicPostEdit}
                        readOnly={!isEditMode}
                        setPublic={setPublicPost}
                        setPublicEdit={setPublicPostEdit}
                    />
                    <GroupSelector
