            ...
            <div id="post-collection-head">
                <div id="post-collection-information-container">
                    ...
                    {isEditMode ? (
                        ...
                        <h2 hidden={!(postCollection && postCollection.title)}>
                            {postCollection && postCollection.title}
                        </h2>
                    )}
                    {isEditMode ? (
                        <TextField
                                    ...
                                    <ActionModal
                                        ...
                                        text={
                                            items.length === 1 && items[0].title
                                                ? `Remove '${items[0].title}' from collection`
                                                : `Remove ${items.length} item${items.length === 1 ? "" : "s"} from collection`
                                        }
                                        actions={[
                                            {
                                                name: "Ok",
