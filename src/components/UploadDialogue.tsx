        ...
        <div className="modal-form">
            <p>
                {isUploadingFolder
                    ...
                    : "Create a post for a new file upload"}
            </p>
            <Paper elevation={2} className="fieldset-paper">
                <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                    <Tabs
                        value={isUploadingFolder ? 1 : 0}
                        onChange={(_e, idx) => {
                ...
                <TabPanel value={isUploadingFolder ? 1 : 0} index={0}>
                    ...
                    <div className="file-selector-row">
                        ...
                        <label className="file-name" style={{ flex: "1" }}>
                            {fileLabel}
                        </label>
                    </div>
                </TabPanel>
            ...
            <div className="modal-form-submit-btn">
                    ...
                    onClick={async (e) => {
                        ...
                        if (isUploadingFolder && fileList) {
                            ...
                            try {
                                ...
                                uploadProgressModal.close();
                                modal.close();
                                app.openModal("Success", (successModal) => (
                                    <p>
                                        <Link
                                            className="standard-link"
                                            to={`post/${postResponse.data.pk + location.search}`}
                ...
                >
                    {isUploadingFolder ? "Create Posts" : "Create Post"}
                </Button>
            </div>
        </div>
    );
