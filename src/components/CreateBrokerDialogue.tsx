        ...
        >
            <div className="form-paper-content">
                ...
                <Paper elevation={4} sx={{ minWidth: "fit-content" }}>
                    ...
                    >
                        ...
                        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                            <Tabs
                                value={isAwsRegion ? 0 : 1}
                                onChange={(_e, idx) => setAwsRegion(idx === 0)}
                ...
                >
                    ...
                    />
                    <Tooltip
                        title="Set this bucket as the system bucket, which will be used for storing system data such as user avatars."
                        placement="right"
                        arrow
                    >
                        <FontAwesomeIcon icon={faCircleInfo} />
