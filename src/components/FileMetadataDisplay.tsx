...
export function FileMetadataDisplay({
    s3_object,
    s3_object_metadata,
}: {
    s3_object: S3Object;
                ...
                <Table sx={{ minWidth: 300 }}>
                    <TableBody>
                        ...
                        <AutoHideTableRow
                            title="Video Codec"
                            value={
                                s3_object_metadata.video_codec_name +
                                " (" +
                                s3_object_metadata.video_codec_long_name +
                                ")"
                            }
                        />
                        <AutoHideTableRow
                        ...
                        <AutoHideTableRow
                            title="Audio Codec"
                            value={
                                s3_object_metadata.audio_codec_name +
                                " (" +
                                s3_object_metadata.audio_codec_long_name +
                                ")"
                            }
                        />
                        <AutoHideTableRow
