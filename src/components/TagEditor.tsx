            ...
            <Autocomplete
                ...
                renderInput={(params) => {
                    ...
                    return (
                        <TextField
                            ...
                            label={label ?? "Tags"}
                            placeholder={
                                (value && value.length > 0) || readOnly ? undefined : "Enter a tag and hit enter"
                            }
                            sx={{
                ...
                renderValue={(tagValue, getTagProps) =>
                    tagValue.map((option, index) =>
                        enableTagLink && readOnly && !(typeof option === "string") ? (
                            <Chip
                                {...getTagProps({ index })}
                                color="secondary"
                                variant="outlined"
                                ...
                                icon={
                                    typeof option === "string" || !option.tag_category
                                        ? undefined
                                        : getIconForTagCategory(option.tag_category)
                                }
                                component={Link}
                                to={`/tag/${option.pk}`}
                                clickable
            ...
            >
                <FormGroup className="form-container">
                    ...
                    <div className="modal-form-submit-btn">
                        <Button color="secondary" type="submit" disabled={tagName.length === 0}>
                            Create
                        </Button>
                    </div>
                </FormGroup>
                ...
                <Button
                    ...
                    onClick={(e) => {
                        ...
                        app.openModal(
                            "Create Tag Category",
                            (createCategoryModal) => (
                                <TagCategoryCreator app={app} modal={createCategoryModal}></TagCategoryCreator>
                            ),
                            (result) => {
                                if (result) {
                                    loadCategories();
        ...
        <div id="TagCategoryCreator" style={{ minWidth: "400px", padding: "5px" }}>
            ...
            >
                <FormGroup className="form-container">
                    ...
                    <div className="modal-form-submit-btn">
                        <Button color="secondary" type="submit" disabled={id.length === 0 || label.length === 0}>
                            Create
                        </Button>
                    </div>
                </FormGroup>
...
export function TagCategoryEditor({
    ...
    const [autoMatchConditionCollection, setAutoMatchConditionCollection] = useState(
        tagCategory.auto_match_condition_collection || ""
    );
        ...
        <div id="TagCategoryCreator" style={{ minWidth: "400px", padding: "5px" }}>
            ...
            >
                <FormGroup className="form-container">
                    ...
                    <div className="modal-form-submit-btn">
                        <Button color="secondary" type="submit" disabled={label.length === 0}>
                            Update
                        </Button>
                    </div>
                </FormGroup>
