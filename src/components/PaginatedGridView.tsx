                    ...
                    {items.map((item) => {
                        ...
                        return (
                            <ImageListItem key={item.pk}>
                                ...
                                <div
                                    key={"footer_action_btn_" + item.pk}
                                    className="paginated_grid_view_item_footer_button"
                                >
                                    {selectionMode ? (
                                        <Checkbox
                                            checked={
            ...
            >
                ...
                <div id="selection-action-tool-row">
                    {selectionMode && isDesktop && (
                        <span className="selected-amount-label">{`${selectedItems.length} selected`}</span>
                    )}
                    {selectionMode ? (
                        <IconButton
                            color="primary"
                    ...
                    {gridItemActions
                        ?.filter((action) => !action.disallowMultiSelect)
                        .map((action) => (
                            <IconButton
    ...
    return (
        <Paper elevation={2} className="post-preview-container">
            <h3 className="preview-title">
                <Link className="undecorated-link" to={searchLink}>
